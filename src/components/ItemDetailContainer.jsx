    ...
    const details = [
      {
        ...
        text:
          "Tetris, video game created by Russian designer Alexey Pajitnov in 1985 that allo" +
      ...
      },
      {
        ...
        text:
          "Roguelike (or rogue-like) is a subgenre of role-playing video games characterize" +
      ...
      },
      {
        ...
        text:
          "A style of platform game in which the player character runs non-stop through a h" +
